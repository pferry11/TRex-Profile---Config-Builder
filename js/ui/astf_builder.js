      ...
      function regen() {
        ...
        regenTimer = setTimeout(function () {
          ...
          TB.ui.output.render(outputPane, { result: gen(model), model: model, validateKind: 'astf',
            /* Re-open lives in the output pane (same pattern as STL/cap2).
               "Open builder file…" restores a .json exactly; the sister
               "Open profile…" (.py) action arrives with the ASTF importer. */
