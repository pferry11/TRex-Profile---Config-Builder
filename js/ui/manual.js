  ...
  var CHAPTERS = [
    { id: 'start', title: 'Getting started', html: function () {
      return '<p>This app builds Cisco TRex configuration artifacts through forms: traffic profiles ' +
        ...
        'generated <code>.py</code> profiles (they round-trip exactly); hand-written STL is arbitrary Python so it maps ' +
        'best-effort, and ASTF <code>.py</code> re-import is still on the roadmap - see <em>Future updates</em>.</p>' +
