...
(function (root) {
  ...
  TB.help = {
    ...
    cap2: {
      ...
      minMaxIp: 'Override the client/server IP range with explicit 32-bit hex bounds (min_src_ip/max_src_ip/min_dst_ip/max_dst_ip), e.g. 0x10000001. Used by rtsp_full1 / sfr_agg.',
